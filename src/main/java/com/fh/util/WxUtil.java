...
public class WxUtil {
    ...
    public static Map xiaDan(String outTrade, String totleMoney) throws Exception {
        ...
        //设置订单号 （保证唯一 ）
        data.put("out_trade_no","weixin1_order_000"+outTrade);
        //设置币种
    ...
    public static Map CxDingDan(String outTrade) throws Exception {
        FeiConfig config = new FeiConfig();
        WXPay wxpay = new WXPay(config);
        Map<String, String> data = new HashMap<String, String>();
        data.put("out_trade_no","weixin1_order_000"+outTrade);
